...
public class PrenotazioneDataAccessService implements PrenotazioneDao {
	...
	public PrenotazioneDataAccessService() {
		db = new ArrayList<>();
		db.add(new Prenotazione(UUID.fromString("842093cc-4f11-4bb4-9aa2-b6809f9a2ee7"), "07-12-2019", "15 : 00",
		...
		db.add(new Prenotazione(UUID.fromString("24de37f4-3a19-11ea-b77f-2e728ce88125"), "10-12-2019", "9 : 30",
		...
		db.add(new Prenotazione(UUID.fromString("951273b4-3a19-11ea-b77f-2e728ce88125"), "11-12-2019", "11 : 00",
